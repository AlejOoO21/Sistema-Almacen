 ...
 * @author Rodrigo
 */
public class TipoServicioDialog extends javax.swing.JDialog {

    /**
     * Creates new form Service_Emergente
     */
    public TipoServicioDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Descripcion de Factura:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoServicioDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipoServicioDialog dialog = new TipoServicioDialog(new javax.swing.JFrame(), true);
